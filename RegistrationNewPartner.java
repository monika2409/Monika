...
//This script Register new partner from aprimo domain and approve.
...
public class RegistrationNewPartner
{
							  ...
							  throws InterruptedException 
	{
		...
		//Approval Process
		//Login with admin contact and approve registered user
		driver.get("https://aprimodm.com/Login2.aspx?ReturnUrl=/");
		Thread.sleep(1000);
		...
		driver.get("https://aprimodm.com/Registration/ApprovePartnerList.aspx");
		Thread.sleep(1000);
		...
		Thread.sleep(1000);
		driver.findElement(By.id("MainContent_dgPartner_lnkEdit_0")).click();
		Thread.sleep(2000);
		driver.findElement(By.id("MainContent_btnSubmit")).click();
		Thread.sleep(4000);
	
		//Check user approved successfully or not.
		try
		{
			Assert.assertEquals(driver.findElement(By.id("MainContent_message")).getText(), "Partner approved successfully", "Company Not registered Successfully.");
		} 
		catch(AssertionError e) 
		{
			...
			System.out.println("Partner approved successfully");
	...
	{
		ReadExcel Config = new ReadExcel("C:\\Users\\monika\\Desktop\\readexcel.xlsx");
		...
		Object[][] data = new Object[rows - dataRowPosition][17];
		...
		for(int i = dataRowPosition; i < rows; i++) 
		{
			...
			data[i - dataRowPosition][15]= Config.getData(0, i, 15);
			data[i - dataRowPosition][16]= Config.getData(0, i, 16);
		}
